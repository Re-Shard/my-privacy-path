      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="card">
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="text-xl font-semibold">Privacy friendly Chat Guide</h3>
              <p className="mt-2 text-gray-600">
                Learn how to secure your email communications and switch to privacy-focused email providers.
              </p>
              <div className="mt-4">
                <Link href="/guides/chat" className="inline-flex items-center text-indigo-600 hover:text-indigo-700">
                  Read Guide
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </div>
