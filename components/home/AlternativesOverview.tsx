...
import { Mail, Cloud, Lock, Globe, MessageCircle } from 'lucide-react';
      ...
      <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        ...
        >
          ...
          <p className="mt-2 text-gray-600">
            Secure email providers that don't scan your messages for
            advertising.
          </p>
        </Link>
        ...
        >
          ...
          <p className="mt-2 text-gray-600">
            Virtual Private Networks that protect your browsing activity and
            location.
          </p>
        </Link>
        ...
        >
          ...
          <p className="mt-2 text-gray-600">
            Encrypted cloud storage solutions that keep your files private.
          </p>
        </Link>
        ...
        >
          ...
          <h3 className="mt-4 text-xl font-semibold">Chat</h3>
          <p className="mt-2 text-gray-600">
            Secure and encrypted chat with your contacts. No spying. All open
            source.
          </p>
        </Link>
        ...
        >
          ...
          <p className="mt-2 text-gray-600">
            Password managers and authentication tools to secure your accounts.
          </p>
        </Link>
      </div>
